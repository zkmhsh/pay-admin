<template>
  <el-card class="box-card">
    ...
    <div class="box-body">
        ...
        <el-col :offset='1' :span='3'>
          <el-select size="mini" placeholder="支付状态">
            <el-option label='全部' value='0'></el-option>
          </el-select>
        </el-col>  
        <el-col :offset='1' :span='3'>
          <el-select size="mini" placeholder="交易类型">
            <el-option label='全部' value='0'></el-option>
          </el-select>
        </el-col> 
        <el-col :offset='1' :span='5'>
          <el-input size="mini" placeholder="合作方交易流水号">
          </el-input>
        </el-col> 
        </el-row>
        ...
        <el-col :offset='1' :span='7'>
          <el-date-picker size='mini'
            type="daterange"
            range-separator="至"
            start-placeholder="支付完成时间"
            end-placeholder="支付完成时间">
            </el-date-picker>
        </el-col>
      ...
      <el-table border striped fit v-if='pageData !== null' :data="pageData.content" style="width: 100%">
        ...
        <el-table-column prop="f3" label="交易类型"></el-table-column>
         
        <el-table-column label="支付状态" width="80">
          <template slot-scope="scope">
            <span v-if="scope.row.f4" style='color: green'>已支付</span>
            <span style='color: red' v-else>待付款</span>
          </template>
        </el-table-column>
        <el-table-column prop="f5" label="返回消息"></el-table-column>
        <el-table-column prop="f6" label="子系统订单号"></el-table-column>

        <el-table-column label="支付发起时间" width='100'>
          <template slot-scope="scope">
            {{ scope.row.f7 | formatDate }} 
          </template>
        </el-table-column>
        <el-table-column prop="f8" label="付款账户"></el-table-column>
        <el-table-column label="订单总额" width='100'>
          <template slot-scope="scope">
            {{ scope.row.f9 | formatCNY }} 
          </template>
        </el-table-column>
        <el-table-column label="分账信息" width='100'>
          <template slot-scope="scope">
            {{ scope.row.f9 | formatCNY }} 
          </template>
        </el-table-column>
        <el-table-column label="支付完成时间" width='100'>
          <template slot-scope="scope">
        ...
        <el-table-column label="交易状态" width="80">
          <template slot-scope="scope">
            <span v-if="scope.row.f12" style='color: green'>正常</span>
...
export default {
  ...
  methods: {
    fetchData () {
        let list = [
            {f1: '采购平台', f2: '电汇', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '商户', f2: '电汇', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '采购平台', f2: '电汇', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '采购平台', f2: '电汇', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '采购平台', f2: '电汇', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '商户', f2: '网银', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '商户', f2: '网银', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '商户', f2: '网银', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '商户', f2: '网银', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
            {f1: '商户', f2: '网银', f3: '收款', f4: '1', f5: 'SUCCESS', f6: 'P91091902', f7: new Date('2019','10','20'), f8: '9001928122', f9: 1283792, f10: '', f11: new Date(), f12: 1},
